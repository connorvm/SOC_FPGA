...
#define A_ALU_CONTROL_OFFSET 0
#define B_ALU_CONTROL_OFFSET 1
#define C_ALU_CONTROL_OFFSET 6
#define OPCODE_ALU_CONTROL_OFFSET 2
#define RL_ALU_CONTROL_OFFSET 3
#define RH_ALU_CONTROL_OFFSET 4
#define STATUS_ALU_CONTROL_OFFSET 5
